...
const formSchema = z.object({
  ...
  groupSpread: z.coerce
    .number()
    .refine((val) => val > 0, { message: 'Group spread must be greater than 0' })
    .refine((val) => val < 1, { message: 'Group spread must be less than 1' }),
  mode: z.string(),
  isSelfRating: z.coerce.boolean(),
  // peerRatingWeights: z.arr
})
    ...
    >
      ...
      <DialogContent>
        <Form {...form}>
          ...
          >
            <DialogHeader>
              <DialogTitle className="text-2xl">Model Selection</DialogTitle>
              <DialogDescription>Enter classroom details. Click create when you're done.</DialogDescription>
            </DialogHeader>
