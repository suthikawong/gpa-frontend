...
import { qassTerminology } from '@/config/tutorial'
import { createFileRoute, redirect, useRouter } from '@tanstack/react-router'
import { ChevronLeft } from 'lucide-react'

export const Route = createFileRoute('/instructor/tutorial/qass-terminology')({
    ...
    <DashboardLayout className="gap-4">
      ...
      <div className="space-y-8">
        <Card className="flex gap-4 w-full shadow-none border-0 py-6 px-2 md:py-8 md:px-4">
          <CardHeader>
            <CardTitle className="text-3xl flex gap-2 items-center m-auto mb-8">QASS Terminologies</CardTitle>
          </CardHeader>
